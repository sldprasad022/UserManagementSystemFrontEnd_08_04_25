...
const Edit = ({ userId,setEditState,refreshData }) => {
  ...
  const fetchByUserId = async () => {
    try 
    {
      const response = await axios.get(`${BASE_URL}api/user/fetchByUserId/${userId}`,
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try 
    {
      const response = await axios.put(`${BASE_URL}api/user/update/${userId}`,form,{
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      //naviagteTo("/userdashboard/allusersdata");
    }
    catch (error) 
    {
